                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($resultado)) {
                        echo "<tr><td><a href='departamento_edit.php?id=" . $row['id'] . "'>" . $row['id'] . " </a></td>
                            <td>" . $row['descricao'] . "</td>
                            <td>
                                <a class='btn btn-warning btn-xs' href='departamento_edit.php?id=" . $row['id'] . "'><i class='fa fa-pencil' aria-hidden='true'></i> Editar</a>
                                <a class='btn btn-danger btn-xs' href='departamento_exc.php?id=" . $row['id'] . "''><i class='fa fa-trash-o' aria-hidden='true'></i> Excluir</a></td>
                            </tr>";
                    }
                    ?>
                </tbody>
